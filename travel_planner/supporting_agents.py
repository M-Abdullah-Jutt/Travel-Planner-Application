...
from travel_planner.tools import google_search_agent, location_search_tool
from google.adk.tools.agent_tool import AgentTool


# LLM = LiteLlm(model="openai/gpt-4.1-mini")
...
travel_inspiration_agent = Agent(
    ...
    instruction="""
        ...
        """,
    tools=[AgentTool(news_agent),AgentTool(places_agent)]
)
